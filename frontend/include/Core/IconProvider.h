...
#define wxART_BRAND_DISCOGS wxART_MAKE_ART_ID(wxID_HIGHEST + 20)
#define wxART_BRAND_YOUTUBE wxART_MAKE_ART_ID(wxID_HIGHEST + 2)
#define wxART_BRAND_SOUNDCLOUD wxART_MAKE_ART_ID(wxID_HIGHEST + 19)
...
#define wxART_VIDEO wxART_MAKE_ART_ID(wxID_HIGHEST + 21)

#define wxART_ARROW_RIGHT wxART_MAKE_ART_ID(wxID_HIGHEST + 16)
#define wxART_TRASH_XMARK wxART_MAKE_ART_ID(wxID_HIGHEST + 17)
#define wxART_ASSESSMENT wxART_MAKE_ART_ID(wxID_HIGHEST + 18)
