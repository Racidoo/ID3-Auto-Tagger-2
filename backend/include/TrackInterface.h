...
class TrackInterface {
  ...
  public:
    ...
    struct TrackViewData {
        ...
        void
        verifyTags(std::shared_ptr<TrackInterface::TrackViewData> _template);
    };

    static std::shared_ptr<TrackViewData> fromLocal(const LocalTrack &_track);
    static std::shared_ptr<TrackViewData>
    fromSpotify(const Spotify::Track &_track);

    static void verify(std::shared_ptr<TrackInterface::TrackViewData> _data,
